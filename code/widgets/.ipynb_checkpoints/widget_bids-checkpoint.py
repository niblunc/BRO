...
# variablesbids
csvs=[x.split("/")[-1] for x in glob.glob(os.path.join('/content/gdrive/My Drive/Projects/bromo/data/reports/csvs', 'bids*.csv'))]
ALL = 'ALL'
data_path='/content/gdrive/My Drive/Projects/bromo/data/reports/csvs'
df_base= pd.read_csv('/content/gdrive/My Drive/Projects/bromo/data/reports/csvs/bids_report.csv')
